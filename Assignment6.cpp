...
void SelectionSort(double numbers[], int numbersSize) {
  ...
  time_t endTime;
    ...
    //   cout << numbers[y] << endl;
    // }
    // cout << "SelectionSort Method is Finished." << endl;
}
...
void InsertionSort(double numbers[], int numbersSize) {
   ...
   // for (int y = 0; y < numbersSize; ++y){
   //   cout << numbers[y] << endl;
   // }
   // cout << "InsertionSort Method is Finished." << endl;
};
...
//    if (lowIndex >= highIndex) {
//       cout << " Partition is already Sorted. " << endl;
//    }
...
//
//    for (int y = 0; y < highIndex; ++y){
//      cout << numbers[y] << endl;
//    }
//    cout << "QuickSort Method is Finished." << endl;
//
// }
...
void bubbleSort(double numbers[], int numbersSize)
{
    ...
    //   cout << numbers[y] << endl;
    // }
    // cout << "BubbleSort Method is Finished." << endl;
}
